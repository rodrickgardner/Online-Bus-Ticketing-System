...
<div class="container">
<div class="spacer">
<center><h3>Available Seats For your Selected Bus</h3></center>
...
$datas =  mysqli_fetch_array(mysqli_query($conms,"SELECT id, route, time, date, seat, stat FROM bus_info WHERE id='".$bid."'"));
