 ...
 ?>
  ...
  <link rel="stylesheet" href="css/bootstrap-wysihtml5.css" />
    ...
    <div class="pageheader">
      <h2><i class="fa fa-th-list"></i> Add New Menu</h2>
    </div>
...
$res = mysqli_query($conms,"INSERT INTO menus SET title='".$title."', btext='".$btext."'");
...
?>	
		...
		<form action="" method="post">
          ...
          <textarea id="wysiwyg" placeholder="Enter text here..." class="form-control" rows="10" name="btext"></textarea>
