 ...
 ?>
  ...
  <link rel="stylesheet" href="css/bootstrap-wysihtml5.css" />
    ...
    <div class="pageheader">
      <h2><i class="fa fa-th-list"></i> EDIT Menu</h2>
    </div>
...
$res = mysqli_query($conms,"UPDATE menus SET title='".$title."', btext='".$btext."' WHERE id='".$eid."'");
...
$old = mysqli_fetch_array(mysqli_query($conms,"SELECT btext, title FROM menus WHERE id='".$eid."'"));
?>	
...
echo " <input name=\"title\" value=\"$old[1]\" class=\"form-control\" type=\"hidden\"> <b>HOME</b>";
			  }else{
echo " <input name=\"title\" value=\"$old[1]\" class=\"form-control\" type=\"text\">";
			  }
			  ?>
			  </div>
            </div>
          ...
          <textarea id="wysiwyg" class="form-control" rows="10" name="btext"><?php echo $old[0]; ?></textarea>
